...
export default function ProfileSection() {
    return (
        <section className="my-32" id="profile">
            <div className="container mx-auto">
                <SectionTitle>Profile</SectionTitle>
                <SectionParagraf>Mengenal saya secara singkat.</SectionParagraf>

                <div className="flex flex-wrap xl:w-9/12 mx-auto mt-14 lg:items-center md:items-start md:px-10">
                    <div className="md:w-5/12 w-full px-10 mb-8 md:mb-0 lg:px-10 md:px-5">
                        <img src="/profile.png" alt="profile" className="w-full" />
                    </div>
                    <div className="md:w-7/12 w-full px-10 lg:px-10 md:px-5">
